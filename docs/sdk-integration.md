...
This note documents the **sdk-integration** of the streampay-contract contract.

streampay-contract is a Soroban smart contract on the Stellar network. This page is part of the
project's reference documentation and describes the sdk-integration in detail, covering the relevant
