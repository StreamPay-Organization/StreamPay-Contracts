...
This note documents the **edge-cases** of the streampay-contract contract.

streampay-contract is a Soroban smart contract on the Stellar network. This page is part of the
project's reference documentation and describes the edge-cases in detail, covering the relevant
